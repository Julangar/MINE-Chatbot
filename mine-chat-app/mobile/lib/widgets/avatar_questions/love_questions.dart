...
class LoveQuestions extends StatefulWidget {
  ...
  const LoveQuestions({super.key, required this.onChanged, required this.initialData});

  @override
  State<LoveQuestions> createState() => _LoveQuestionsState();
}

class _LoveQuestionsState extends State<LoveQuestions> {
  ...
  final _relationshipOptions = [
    'Novia/o', 'Espos@', 'Pareja', 'Crush', 'Otro'
  ];
  final _referenceOptions = [
    'Amor', 'Mi vida', 'Mi cielo', 'Por tu nombre', 'Otro'
  ];
  final _tones = ['Romántico', 'Apasionado', 'Respetuoso', 'Divertido'];
  final _topics = ['Apoyo emocional', 'Motivación', 'Detalles', 'Reflexión'];
  final _phrases = [
    'Siempre juntos', 'Te amo', 'Confío en ti', 'Nuestro futuro', 'Mi cómplice'
  ];
    ...
    return Column(
      children: [
        ...
        DropdownButtonFormField<String>(
          decoration: const InputDecoration(labelText: 'Tipo de relación', labelStyle: TextStyle(color: Colors.white)),
...
validator: (val) {
            ...
            if ((val == 'Otro') && (_customRelationshipOrRole == null || _customRelationshipOrRole!.isEmpty)) {
              return 'Por favor, especifica el tipo de relación sentimental';
            }
            return null;
          },
        ),
